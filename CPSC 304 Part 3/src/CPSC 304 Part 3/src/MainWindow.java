...
public class MainWindow extends Application {
        ...
        reserveButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    Reservation reserve = dbhandler.createReservation(Integer.parseInt(licenseField.getText()), carTypeWantedField.getText(), con, fDate, tDate);
                    createReservationWindow(reserve, carType.getText());
    ...
    private void createReservationWindow(Reservation reserve, String carType){
...
//        scroll.setVbarPolicy(ScrollPane.ScrollBarPolicy.ALWAYS);
    ...
    public static void main(String[] args) {
        ...
        // ssh -l davidc21 -L localhost:1522:dbhost.students.cs.ubc.ca:1522 remote.students.cs.ubc.ca
        launch(args);
    }
}
